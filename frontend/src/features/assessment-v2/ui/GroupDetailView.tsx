...
import { ChevronLeft, ChevronDown, ClipboardList, Copy, QrCode, Link2, Check } from 'lucide-react';
                    ...
                    {allGroups.map((g) => (
                      ...
                      >
                        ...
                        <div className='vj-gswitch-item-mt'>
                          {SCHOOL_LEVEL_LABELS[g.schoolLevel] ?? g.schoolLevel} {g.grade}학년 · 학생{' '}
                          {g.activeMemberCount || g.memberCount}명
                        </div>
