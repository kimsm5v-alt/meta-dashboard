...
export function useClassDetailData(classData: Class, round: 1 | 2 = 1): ClassDetailData {
  return useMemo(() => {
    ...
    criticalStudents.sort(
      (a, b) =>
        b.reasons.length - a.reasons.length || b.severeFactors.length - a.severeFactors.length,
    );
