...
function calculateStep3(tScores: number[], mid: ReturnType<typeof calculateMidCategories>) {
...
const 코칭전략Map: Record<string, string[]> = {
  '1-1': ['학습 상위 목표 설정', '과도한 기대, 압박 조심', '진로 목표 & 미래역량개발'],
  '1-2': [
    "'습' 중심의 공부 습관 형성 필요",
    '선호 과목과 성적 확인(인지능력)',
    '가정에서 학습지도 파악',
  ],
  '2-1': ['단계적 효능감 강화 전략', '활용 및 대처자원 탐색 & 강화', '스트레스 대처능력 강화'],
  '2-2': [
    '강점 기술을 약점 기술에 적용',
    '활용 및 대처 자원 탐색 & 강화',
    '학습 지속 기간 확인 후 지지',
  ...
  '4-1': ['공부 낙심 사건 탐색 & 재해석', '공부 이유 탐색과 적용', '단계적 공부마음 향상 전략'],
  '4-2': [
