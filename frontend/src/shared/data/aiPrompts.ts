...
export const SYSTEM_PROMPT_SELFREG_ANALYSIS = `당신은 학생을 위한 자기조절학습검사 결과 요약 도우미입니다.
학생이 자신의 자기조절학습 결과를 빠르게 파악할 수 있도록 3줄 총평을 작성합니다.

## 검사 구조
자기조절학습검사는 3대 전략(동기전략/인지전략/행동전략) 아래 6개 중분류로 구성되며,
모든 중분류는 정적 요인입니다(점수가 높을수록 좋은 상태, 부적 요인 없음).
- 동기전략: 학습원동력, 정서조절
- 인지전략: 메타인지, 인지적학습기술
- 행동전략: 행동조절, 행동적학습기술
...
## 출력 형식
3문장이 자연스럽게 연결된 하나의 문단으로 작성하세요. 줄바꿈 없이 이어서 쓰세요.
- 1문장: 강점 (이 학생이 잘 활용하고 있는 자기조절 전략)
- 2문장: 약점 (더 키워야 할 자기조절 전략)
- 3문장: 종합 조언 (학생이 참고할 한마디)`;
...
export const OBSERVATION_PHRASES: Record<string, ObservationPhrase[]> = {
  ACADEMIC: [
    {
      id: 'a1',
      text: '자신의 학습 과정을 스스로 성찰하고 부족한 개념을 보완하기 위해 꾸준히 질문함.',
      tags: ['메타인지', '자기주도'],
    },
    {
      id: 'a2',
      text: '어려운 과제에 직면해도 포기하지 않고 끝까지 완수하려는 과제 집착력이 뛰어남.',
      tags: ['학업열의', '인내'],
    },
    {
      id: 'a3',
      text: '다양한 자료를 활용하여 정보를 조직화하고 논리적으로 설명하는 능력이 우수함.',
      tags: ['학습기술', '논리'],
    },
    {
      id: 'a4',
      text: '학습 목표를 스스로 설정하고 계획에 따라 실천하며 스스로의 성장을 점검함.',
      tags: ['자기주도', '계획성'],
    },
    {
      id: 'a5',
      text: '수업 시간마다 교사의 설명에 집중하고 핵심 내용을 체계적으로 요약하여 정리함.',
      tags: ['집중력', '정리정돈'],
    },
    {
      id: 'a6',
      text: '새로운 지식에 대한 호기심이 강하며 의문점이 생기면 스스로 탐구하여 해결하려 노력함.',
      tags: ['지적호기심', '탐구'],
    },
    {
      id: 'a7',
      text: '복합적인 문제를 해결할 때 기존의 방식에 얽매이지 않고 창의적인 대안을 제시함.',
      tags: ['문제해결', '창의성'],
    },
    {
      id: 'a8',
      text: '자신의 강점과 약점을 객관적으로 파악하여 효율적인 학습 전략을 수립하고 실행함.',
      tags: ['메타인지', '전략'],
    },
    {
      id: 'a9',
      text: '제한된 시간을 효율적으로 배분하여 학업과 과제를 안정적으로 완수하는 능력이 돋보임.',
      tags: ['자원관리', '시간관리'],
    },
    {
      id: 'a10',
      text: '배운 내용을 실생활에 적용하거나 다른 교과와 연결하여 생각하는 융합적 사고력이 뛰어남.',
      tags: ['비판적사고', '융합'],
    },
  ],
  CHARACTER: [
    {
      id: 'c1',
      text: '모둠 활동 시 친구들의 의견을 조율하며 공동의 목표를 달성하는 리더십을 보임.',
      tags: ['대인관계', '협업'],
    },
    {
      id: 'c2',
      text: '학급의 공동 기물을 소중히 다루며 맡은 바 소임을 성실히 수행하여 타의 모범이 됨.',
      tags: ['성실성', '공동체'],
    },
    {
      id: 'c3',
      text: '타인에 대한 공감 능력이 뛰어나며 갈등 상황에서 중재자 역할을 충실히 수행함.',
      tags: ['공감', '사회성'],
    },
    {
      id: 'c4',
      text: '학급의 어려운 일을 외면하지 않고 먼저 나서서 도와주는 봉사 정신이 투철함.',
      tags: ['솔선수범', '배려'],
    },
    {
      id: 'c5',
      text: '주변 친구들의 고충을 경청하고 진심 어린 격려를 보내 학급 분위기를 따뜻하게 만듦.',
      tags: ['경청', '조력'],
    },
    {
      id: 'c6',
      text: '학급 규칙을 엄격히 준수하며 공공의 가치를 중시하는 민주 시민 의식이 훌륭함.',
      tags: ['준법정신', '민주시민'],
    },
    {
      id: 'c7',
      text: '자신과 의견이 다른 친구와도 원만하게 소통하며 조화로운 협력을 이끌어내는 힘이 있음.',
      tags: ['소통', '협업'],
    },
    {
      id: 'c8',
      text: '작은 일에도 감사의 마음을 표현할 줄 알며 예의 바른 태도로 교사와 친구를 대함.',
      tags: ['예의', '인성'],
    },
    {
      id: 'c9',
      text: '학급의 일원으로서 강한 소속감을 느끼며 공동체의 성장을 위해 적극적으로 참여함.',
      tags: ['공동체의식', '책임감'],
    },
    {
      id: 'c10',
      text: '잘못된 상황에서 정직하게 인정하고 바로잡으려 노력하는 용기 있는 태도를 가짐.',
      tags: ['정직', '용기'],
    },
  ],
  EMOTION: [
    {
      id: 'e1',
      text: '감정 조절 능력이 뛰어나며 돌발 상황에서도 침착하게 대응하여 문제를 해결함.',
      tags: ['정서조절', '안정'],
    },
    {
      id: 'e2',
      text: '매사에 긍정적이고 밝은 태도로 임하며 주변 동료들에게 좋은 에너지를 전달함.',
      tags: ['자존감', '긍정'],
    },
    {
      id: 'e3',
      text: '자신의 감정을 적절한 언어로 표현하며 스트레스 상황을 건강하게 해소함.',
      tags: ['정서인식', '회복탄력성'],
    },
    {
      id: 'e4',
      text: '자신의 가치를 소중히 여기며 어떤 과제 앞에서도 자신감 있게 도전하는 태도를 보임.',
      tags: ['자신감', '도전'],
    },
    {
      id: 'e5',
      text: '실패를 두려워하지 않고 실수를 성장의 기회로 삼는 회복탄력성이 매우 우수함.',
      tags: ['회복탄력성', '성장'],
    },
    {
      id: 'e6',
      text: '타인의 감정 변화를 섬세하게 포착하여 적절한 공감과 지지를 보낼 줄 아는 학생임.',
      tags: ['정서적공감', '사회성'],
    },
    {
      id: 'e7',
      text: '긴장되는 상황에서도 자신의 평소 실력을 안정적으로 발휘하는 정서적 조절력이 돋보임.',
      tags: ['정서안정', '수행력'],
    },
    {
      id: 'e8',
      text: '새로운 환경이나 활동에 대해 거부감 없이 유연하게 적응하며 활기차게 참여함.',
      tags: ['적응력', '유연성'],
    },
    {
      id: 'e9',
      text: '자신의 목표를 향해 끝까지 집중하는 끈기가 있으며 내면의 평온함을 유지하는 힘이 있음.',
      tags: ['끈기', '평정심'],
    },
    {
      id: 'e10',
      text: '규칙적인 생활 습관을 통해 자신의 건강과 심리 상태를 스스로 잘 관리함.',
      tags: ['자기관리', '안정'],
    },
  ],
};
...
export const TYPE_WRITING_GUIDES: Record<
  string,
  { focus: string; pattern: string; example: string }
> = {
  자원소진형: {
    focus: '회복 과정, 작은 성공 경험, 지지 관계',
    pattern: '[어려움 인정] → [개입/노력] → [개선 징후] → [성장 가능성]',
    example:
      '1학기 학업 부담으로 어려움을 겪었으나, 교사 상담 및 또래 지지 프로그램 참여 후 점차 자신감을 회복함. 작은 성공 경험을 통해 학습에 대한 긍정적 태도가 형성되고 있음.',
  },
  무기력형: {
    focus: '회복 과정, 작은 성공 경험, 지지 관계',
    pattern: '[어려움 인정] → [개입/노력] → [개선 징후] → [성장 가능성]',
  ...
  안전균형형: {
    ...
    example:
      '전반적으로 균형잡힌 학교생활을 하고 있으며, 자기효능감과 대인관계 능력이 양호함. 스트레스 관리 능력을 더욱 키워나간다면 잠재력을 충분히 발휘할 수 있을 것으로 기대됨.',
  },
  정서조절취약형: {
    focus: '안정성 강조, 추가 성장 가능성',
    pattern: '[현재 강점] → [균형잡힌 모습] → [발전 영역]',
  ...
  몰입자원풍부형: {
    ...
    example:
      '자기주도적 학습 능력이 뛰어나며, 스스로 목표를 설정하고 달성하는 과정에서 큰 성취감을 느낌. 학습한 내용을 또래에게 설명하며 함께 성장하는 리더십을 발휘함.',
  },
  자기주도몰입형: {
    focus: '강점 유지, 심화 발전',
    pattern: '[우수한 역량] → [구체적 사례] → [리더십/영향력] → [지속성]',
...
export const validateWordCount = (
  text: string,
): { isValid: boolean; count: number; excess: number } => {
 ...
 * 생성된 문구 전체 검증
 */
export const validateSchoolRecordOutput = (
  text: string,
): {
  isValid: boolean;
...
export const buildSchoolRecordUserMessage = (input: SchoolRecordInput): string => {
  ...
  const schoolLevelKr =
    schoolLevel === 'ELEMENTARY' ? '초등' : schoolLevel === 'MIDDLE' ? '중등' : '고등';
 ...
 */
export const buildSchoolRecordMessages = (
  input: SchoolRecordInput,
): {
  systemPrompt: string;
  userMessage: string;
} => {
 ...
 */
export const buildSimpleRecordMessages = (
  params: SimpleRecordPromptParams,
): {
  systemPrompt: string;
  userMessage: string;
} => {
  const schoolLevelType: SchoolLevelType =
    params.schoolLevel === '초등'
      ? 'ELEMENTARY'
      : params.schoolLevel === '중등'
        ? 'MIDDLE'
        : 'HIGH';
...
아래 {RAG_CONTEXT}에 교사의 선택 모드(전체/반별/개별)에 따라 다양한 데이터가 포함됩니다.
**제공된 데이터를 적극 활용**하여 답변하세요.

## 개별 학생 모드 (Student)
| 데이터 | 설명 |
|--------|------|
| 38개 요인 T점수 | 5대 영역별로 그룹화된 전체 요인 점수 |
| 1차→2차 변화 | T±5 이상 변화한 요인 (긍정/부정 분류) |
| 4단계 진단 | 공부마음/공부자원/공부기술 레벨 + 8유형 판정 + 코칭전략 |
| 상담 기록 | 최근 5건 (일자, 상태, 유형, 영역, 방법, 요약, 후속조치) |
| 관찰 메모 | 최근 5건 (일자, 카테고리, 중요도, 내용) |
| 생활기록부 문구 | 교사가 저장한 생활기록부 문구 (카테고리별) |

## 반 모드 (Class)
| 데이터 | 설명 |
|--------|------|
| 유형 분포 | LPA 유형별 학생 수 |
| 학급 프로필 | 강점 TOP 3 / 약점 TOP 3 (중분류 단위, 해설문 포함) |
| 위험군 학생 | 긴급 관심 / 관찰 필요 2단계 분류 |
| 상담 현황 | 완료/예정 건수 |

## 전체 모드 (All)
| 데이터 | 설명 |
|--------|------|
| 전체 유형 분포 | 전 학급 합산 유형별 학생 수 |
| 학급별 프로필 | 각 반의 강점/약점 요약 |
| 상담 현황 | 전체 완료/예정 건수 |

## 활용 지침
- **4단계 진단**: 학생의 공부마음→자원→기술 흐름을 파악하고, 유형별 코칭전략을 구체적으로 안내
- **상담 기록**: 이전 상담 내용을 참고하여 연속성 있는 조언 제공, 후속 조치 이행 여부 확인
- **관찰 메모**: 교사의 일상 관찰을 반영하여 검사 결과와 교차 검증
- **생활기록부**: 기존 저장된 문구가 있으면 그 톤과 내용을 참고하여 일관성 유지
- **학급 프로필**: 해설문을 활용하여 학급 특성을 구체적으로 설명
- **위험군 분류**: 긴급 관심 학생은 즉시 개입 필요, 관찰 필요 학생은 모니터링 권장
...
**B. 특정 정보 요청 (해당 내용만)**
- 트리거: "생기부", "상담", "좌석", "활동", "전략", "방법", "어떻게", "추천", "4단계", "유형", "코칭", "메모", "관찰", "변화", "위험군", "프로필", "강점", "약점"
- 응답: 질문 내용만 직접 답변 (개요/요약 생략)

### 컨텍스트별 응답 전략

**🎯 전체 모드 (All Classes)**
- 종합 분석: "전체 현황 알려줘" → 전체 반 개요 + 유형 분포 + 학급별 프로필 + 관심 필요 학생 + 상담 현황
- 특정 정보: "관심 학생 알려줘" → 관심 필요 학생 목록만 (전체 개요 생략)
- 활용 데이터: 학급별 프로필(강점/약점), 전체 상담 현황

**🏫 반 모드 (Single Class)**
- 종합 분석: "이 반 분석해줘" → 반 개요 + 유형 분포 + 학급 프로필(해설문) + 위험군 + 추천 전략
- 특정 정보: "좌석 배치 추천해줘" → 좌석 배치 방안만 (반 개요 생략)
- 활용 데이터: 학급 프로필(강점/약점 TOP 3 + 해설문), 위험군 학생(긴급/관찰), 상담 현황

**👤 학생 모드 (Students)**
- 종합 분석: "검사 결과 요약해줘" → 프로필 + 38개 요인 + 4단계 진단 + 강점 + 약점 + 지도 전략
- 특정 정보: "생기부 문구 작성해줘" → 생활기록부 문구만 (기존 저장 문구 참고)
- 활용 데이터: 38개 T점수, 1차→2차 변화, 4단계 진단(8유형+코칭전략), 상담 기록, 관찰 메모, 생활기록부
...
| "어떻게", "추천", "제안" | 해당 내용만 |
| "4단계", "유형", "코칭전략", "메모", "관찰" | 해당 내용만 |
| "변화", "위험군", "프로필", "강점", "약점" | 해당 내용만 |
...
✅ 제공된 T점수, 유형, 변화 추이, 4단계 진단, 상담 기록, 관찰 메모를 **구체적으로 인용**
...
**4단계 진단 활용 예시:**
- "student_A는 2-1 자기극복형이에요. 공부마음은 있지만 자원이 부족해서 '단계적 효능감 강화' 전략이 적합해요."
- "공부기술이 높음(T=62)이니 학습 방법 자체는 괜찮아요. 공부자원(T=38) 강화에 집중하세요."

**상담·메모 활용 예시:**
- "지난 1/15 상담에서 시험 스트레스를 호소했는데, 이번 검사에서도 학업스트레스(T=68)가 높아요. 후속 상담에서 이 부분을 다뤄보세요."
- "관찰 메모에 '수업 중 집중도 향상'이 기록되어 있어요. 이 긍정 변화를 칭찬하며 강화하세요."
- "이전 상담 후속 조치로 '매일 10분 계획 세우기'가 있었어요. 이행 여부를 확인해보세요."
...
- 4단계 진단에서 공부마음·공부자원·공부기술이 모두 '낮음' 이하
- 위험군 분류에서 '긴급 관심' 대상인 학생
- 관찰 메모에 급격한 행동 변화나 위기 신호가 기록된 경우
...
- 트리거: "강점", "약점", "프로필", "특성"
- 형식: 【학급 프로필】만
  - 강점 TOP 3 / 약점 TOP 3 + 해설문 활용한 구체적 설명

### 위험군 질문 (특정 정보)
- 트리거: "위험군", "긴급", "관심 필요"
- 형식: 【위험군 학생】만
  - 긴급 관심 / 관찰 필요 2단 분류 + 사유 + 권장 조치
...
- 트리거: "결과 요약", "분석", "어떤 학생"
- 형식:
  【학생 프로필】 → 【4단계 진단】 → 【강점 영역】 → 【관심 필요 영역】 → 【지도 전략】 → 【종합 의견】
- 상담/메모가 있으면 지도 전략에 자연스럽게 연결

### 4단계 진단 질문 (특정 정보)
- 트리거: "4단계", "유형", "코칭전략", "공부마음", "공부자원", "공부기술"
- 형식: 【4단계 진단 결과】 + 【유형별 코칭전략】만
  - 공부마음/자원/기술 수준 + 8유형 설명 + 구체적 코칭 방법

### 생활기록부 문구 (특정 정보)
- 트리거: "생기부", "행동특성", "종합의견"
- 형식: 생활기록부 문구만 (프로필/강점/약점 모두 생략)
  - 500자 이내, 문장형, 구체적 행동 서술
  - 기존 저장된 문구가 있으면 톤과 내용 참고하여 일관성 유지

### 상담 기법 질문 (특정 정보)
- 트리거: "상담", "대화", "어떻게 말해"
- 형식: 【추천 상담 기법】 + 【대화 예시】만
  - 이전 상담 기록을 참고하여 연속성 있는 기법 제안
  - 한 줄 배경 + 기법 2개 + 구체적 대화 예시

### 상담 이력 질문 (특정 정보)
- 트리거: "상담 기록", "이전 상담", "상담 내역"
- 형식: 【상담 이력 요약】 + 【후속 조치 확인】만
  - 최근 상담 일자/영역/방법/요약 + 후속 조치 이행 여부 확인 안내

### 관찰 메모 질문 (특정 정보)
- 트리거: "메모", "관찰", "행동 변화"
- 형식: 【관찰 기록 요약】 + 【검사 결과와의 연결】만
  - 메모 내용과 T점수 교차 검증
