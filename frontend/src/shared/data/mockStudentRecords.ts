...
export const mockCounselingRecords: CounselingRecord[] = [
  // class-6-2 학생 1번 (김민준)
  {
    ...
    summary:
      '1차 검사 결과를 바탕으로 학습 태도에 대해 상담함. 메타인지 영역이 낮게 나와 자기 점검 습관의 필요성을 설명함. 특히 시험 전 계획 세우기와 학습 후 복습 점검에 대해 구체적인 방법을 안내함.',
  ...
  },
  {
    ...
    methods: ['face-to-face'],
    summary:
      '학습 일지 작성 점검. 일주일 중 5일 작성 완료. 자기 점검 능력이 조금씩 향상되고 있음. 수학 과목에서 어려움을 느끼고 있어 방과후 보충 수업 권유함.',
  ...
  // class-6-2 학생 2번 (이서연)
  {
    ...
    methods: ['face-to-face'],
    summary:
      '진로 탐색 상담. 과학에 관심이 많아 과학자가 되고 싶다고 함. 관련 직업군과 필요한 역량에 대해 안내하고, 과학 동아리 활동 권유함.',
  ...
  // class-6-2 학생 3번 (박지호)
  {
    ...
    methods: ['face-to-face'],
    summary:
      '친구들 사이에서 갈등이 있다고 호소. 상황 파악을 위해 관련 학생들과 개별 면담 예정. 담임으로서 교실 내 분위기 개선을 위한 활동 계획 수립.',
  ...
  },
  {
    ...
    methods: ['face-to-face'],
    summary:
      '지난주 면담 이후 상황 점검. 관련 학생들과 화해 과정을 거쳤고, 현재는 관계가 많이 개선됨. 학생 본인도 자신감을 되찾아가는 모습.',
...
export const mockObservationMemos: ObservationMemo[] = [
  // class-6-2 학생 1번 (김민준)
  {
    ...
    category: 'behavior',
    content:
      '수업 시간에 집중력이 높아짐. 특히 수학 시간에 적극적으로 질문함. 이전보다 노트 정리도 꼼꼼하게 하는 모습.',
    isImportant: false,
    createdAt: new Date('2026-01-20'),
    updatedAt: new Date('2026-01-20'),
  },
  {
    ...
    category: 'social',
    content:
      '모둠 활동에서 리더 역할을 자처함. 친구들의 의견을 경청하고 조율하는 모습이 인상적. 갈등 상황에서도 차분하게 대처함.',
    isImportant: true,
    createdAt: new Date('2026-01-25'),
    updatedAt: new Date('2026-01-25'),
  },
  {
    ...
    category: 'emotion',
    content:
      '최근 표정이 밝아지고 친구들과 잘 어울림. 쉬는 시간에 친구들과 웃으며 대화하는 모습이 자주 목격됨.',
    isImportant: false,
  ...
  },
  {
    ...
    category: 'academic',
    content:
      '수학 단원평가에서 85점 획득. 이전 평가 대비 15점 상승. 꾸준히 노력한 결과가 성적으로 나타남.',
    isImportant: true,
  ...
  // class-6-2 학생 3번 (박지호)
  {
    ...
    category: 'emotion',
    content:
      '아침에 우울해 보이는 표정. 친구 관계에서 어려움을 겪고 있는 것 같음. 관심을 갖고 지켜볼 필요 있음.',
    isImportant: true,
...
export const mockSavedSchoolRecords: SavedSchoolRecord[] = [
  // class-6-2 학생 1번 (김민준)
  {
    ...
    content:
      '학습에 대한 열의가 있으며, 자기 점검 능력이 발전하고 있는 학생임. 모둠 활동에서 리더십을 발휘하며 친구들과 원만하게 소통하는 모습을 보임. 어려움이 있어도 포기하지 않고 끈기 있게 도전하는 자세가 돋보임.',
    createdAt: new Date('2026-01-30'),
  },
  {
    id: 'sr-2',
    ...
    category: 'learning',
    content:
      '수업에 적극적으로 참여하며, 모르는 부분은 질문을 통해 해결하려는 태도가 돋보임. 학습 일지를 꾸준히 작성하며 자기 주도적 학습 습관을 형성해 나가고 있음.',
    createdAt: new Date('2026-01-28'),
  },
  // class-6-2 학생 2번 (이서연)
  {
    ...
    category: 'comprehensive',
    content:
      '과학 분야에 대한 높은 관심과 탐구심을 가지고 있으며, 실험 활동에서 세심한 관찰력을 보임. 진로에 대한 뚜렷한 목표 의식이 있어 꾸준히 관련 활동에 참여하고 있음.',
    createdAt: new Date('2026-01-25'),
  },
  {
    id: 'sr-4',
    ...
    content:
      '책임감이 강하고 맡은 일은 끝까지 완수하는 성실한 태도를 보임. 다른 사람을 배려하는 마음이 있어 친구들에게 신뢰를 받고 있음.',
    createdAt: new Date('2026-01-27'),
  },
  // class-6-2 학생 3번 (박지호)
  {
    ...
    content:
      '또래 관계에서 어려움을 겪기도 했으나, 이를 극복하며 대인관계 능력이 크게 성장함. 갈등 상황에서 상대방의 입장을 이해하려 노력하고, 화해를 위한 적극적인 자세를 보임.',
...
export const mockMemoService = {
  ...
  create: async (
    input: Omit<ObservationMemo, 'id' | 'createdAt' | 'updatedAt'>,
  ): Promise<ObservationMemo> => {
    await delay(300);
