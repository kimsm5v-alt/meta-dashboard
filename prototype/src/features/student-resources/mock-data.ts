 ...
 */
import type { StudentTask, StudentReportItem, StudentArticle, StudentResponse, StudentReportDetail } from './types';

/** 학생 본인 (목업) */
export const STUDENT_ME = '김서준';
...
/** 5-1 대시보드: 나에게 배정된 활동 */
export const STUDENT_REPORTS: StudentReportItem[] = [
...
// --- sr-1 갈등 해결 시나리오 (김서준 응답, 교사 데이터셋과 정합) ---
const SR1_ARTICLES: StudentArticle[] = [
  { id: 'art-1', order: 1, nature: '개념', itemType: '-', title: '갈등이란 무엇일까?' },
  { id: 'art-2', order: 2, nature: '문항', itemType: 'choice', title: '갈등 상황 파악하기', correctAnswer: '3' },
  ...
  { id: 'art-5', order: 5, nature: '문항', itemType: 'ox', title: '갈등 해결 O/X 퀴즈', correctAnswer: 'O' },
  { id: 'art-6', order: 6, nature: '활동', itemType: 'audio', title: '친구에게 사과 녹음하기' },
];
const SR1_RESPONSES: StudentResponse[] = [
  { articleId: 'art-1', submitAnswer: '', errata: 4, captureImage: '개념 캡처' },
  { articleId: 'art-2', submitAnswer: '3', errata: 1, captureImage: '선택형 캡처' },
  { articleId: 'art-3', submitAnswer: '친구와 다퉜을 때 먼저 사과했다', errata: 4, captureImage: '서술형 캡처' },
...
// --- sr-4 정서 안정 호흡 활동 (활동 중심, 정답 없음) ---
const SR4_ARTICLES: StudentArticle[] = [
...
const SR4_RESPONSES: StudentResponse[] = [
...
/** 5-2 상세 (완료 활동만 상세 존재) */
export const STUDENT_REPORT_DETAILS: Record<string, StudentReportDetail> = {
  'sr-1': {
    id: 'sr-1',
    title: '갈등 해결 시나리오',
    summary: { pages: 6, totalPages: 6, correctN: 2, gradedN: 2, durationSec: 320, submittedAt: '2026-07-18 14:23' },
  ...
  'sr-4': {
    id: 'sr-4',
    title: '정서 안정 호흡 활동',
    summary: { pages: 3, totalPages: 3, correctN: 0, gradedN: 0, durationSec: 240, submittedAt: '2026-07-03 10:12' },
