...
import { ClipboardList, Play, RotateCcw, BarChart3, Clock, CheckCircle2, RefreshCw } from 'lucide-react';
      ...
      case 'waiting':
        return (
          <p className="text-sm text-blue-600 bg-blue-50 rounded-lg p-3 mt-3">
            검사가 시작되었어요! [시작하기] 버튼을 누르면 검사를 진행할 수 있어요.
          </p>
        );
      case 'in_progress':
        return (
          ...
          {exam.status === 'in_progress' && (
            <div className="mt-3">
              <div className="flex items-center justify-between text-sm mb-1">
                <span className="text-gray-500">현재 응답 현황</span>
