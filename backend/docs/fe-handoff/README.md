...
| 4 | [paper-permission-fe-guide.md](./paper-permission-fe-guide.md) | 검사 유형(paperIdx) 권한 | `GET /api/dgnss/paper-permission/me` (메뉴·토글 노출) · `tc/info` **paperIdx 필터** · `tc/start` 미허용 시 **403 `PAPER_NOT_ALLOWED`** |
